...
async function loadBlog() {
    try {
        ...
        const copiedPosts = [...blogPosts]
        // Sort all posts from newest to oldest
        const sortedPosts = copiedPosts.sort((a, b) => b.id - a.id)

        // Get the latest 6
        const latestPosts = sortedPosts.slice(0, 6)

        // Render latest 6 in featured section
        renderBlog(latestPosts, "latest-posts")

        // Render all posts in main container
        renderBlog(blogPosts, "landing-page-blog-posts")
